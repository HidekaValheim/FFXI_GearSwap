...
--Special status Removal
	['Erase']='Erase',['Esuna']='Esuna',['Cursna']='Cursna',
--BarElements
...
--Non RDM Enspell Magic	
    ['Enlight']='Enlight',['Enlight II']='Enlight',['Endark']='Endark',['Endark II']='Endark',['Auspice']='Auspice',
--BLM DOTs
...
--Accuracy Reliant Spells
    ['Sleep']='macc', ['Sleep II']='macc', ['Sleepga']='macc', ['Silence']='macc',['Inundation']='macc',['Dispel']='macc', ['Dispelga']='Dispelga',
...
function update_active_ja(name, gain)
	Buff['Sublimation']= buffactive['Sublimation: Activated'] or false
...
function midcast(spell)
	...
	elseif spell.name:match('Cura') or spell.name:match('Curaga') then
        if spell.element == world.weather_element or spell.element == world.day_element then
            ...
            equip(sets.midcast.Curaga.normal)
        end
...
function idle()
    ...
    if player.status=='Engaged' then
		...
		update_active_ja()
        if Buff['Sublimation'] then
			equip(sets.me.sublimation)
		elseif Buff['Sublimation'] == false and player.mpp < 51 then
