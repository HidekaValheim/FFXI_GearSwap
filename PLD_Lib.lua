...
--PLD Spells
	...
	['Cocoon']='Enmity',['Jettatura']='Enmity',['Geist Wall']='Enmity',['Blank Gaze']='Enmity',['Sheep Song']='Enmity',['Soporific']='Enmity',['Bomb Toss']='Enmity',
	['Blastbomb']='Enmity'
...
function midcast(spell)
    ...
    -- Curing
    if spell.name:match('Cure') or spell.name:match('Cura') or spell.name:match('Healing') then
